...
df_rec["Death_91_365"] <-  ifelse((df_rec$day_after_icu_discharge_death > 90) & (df_rec$day_after_icu_discharge_death<=365), 1, 0) 
df_rec["Death_365"] <-  ifelse((df_rec$day_after_icu_discharge_death > 365) , 1, 0) 
...
## AKI BIN 
#### Grouping 0 (recovered - discharge creathine within 25% of admit) and 3 (never had AKI per KDIGO) together to the value of 0.  If there was AKI per kdigo, and there was no recovery, then the value is 1.

```{r add discharge bin}
df_rec["AKI_discharge_bin"] <- ifelse(((df_rec$AKI_discharge == 0) | (df_rec$AKI_discharge == 3) ), 0, 1)
```
...
AKI_KDIGO_91_365.lm =lm(Death_91_365 ~ AKI,  df_rec)
summary(AKI_KDIGO_91_365.lm)
AKI_KDIGO_365.lm =lm(Death_365 ~ AKI,  df_rec)
summary(AKI_KDIGO_365.lm)
```
...
AKI_KDIGO_91_365.mlm = glm(Death_91_365 ~ AKI + oasis + gender + age + admission_type ,  df_rec, family = "binomial")
summary(AKI_KDIGO_91_365.mlm)
AKI_KDIGO_365.mlm = glm(Death_365 ~ AKI + oasis + gender + age + admission_type ,  df_rec, family = "binomial")
summary(AKI_KDIGO_365.mlm)
```
...
AKI_DIS_91_365.lm =lm(Death_91_365 ~ AKI_discharge_bin,  df_rec)
summary(AKI_DIS_91_365.lm)
AKI_DIS_365.lm =lm(Death_365 ~ AKI_discharge_bin,  df_rec)
summary(AKI_DIS_365.lm)
```
...
AKI_DIS_91_365.mlm = glm(Death_91_365 ~ AKI_discharge_bin + oasis + gender + age + admission_type ,  df_rec, family = "binomial")
summary(AKI_DIS_91_365.mlm)
AKI_DIS_365.mlm = glm(Death_365 ~ AKI_discharge_bin + oasis + gender + age + admission_type ,  df_rec, family = "binomial")
summary(AKI_DIS_365.mlm)
```
...
AKI_cr_gr_3_91_365.lm =lm(Death_91_365 ~ cr_gr_3,  df_rec)
summary(AKI_cr_gr_3_91_365.lm)
AKI_cr_gr_3_365.lm =lm(Death_365 ~ cr_gr_3,  df_rec)
summary(AKI_cr_gr_3_365.lm)
```
...
AKI_cr_gr_3_91_365.mlm = glm(Death_91_365 ~ cr_gr_3 + oasis + gender + age + admission_type ,  df_rec, family = "binomial")
summary(AKI_cr_gr_3_91_365.mlm)
AKI_cr_gr_3_365.mlm = glm(Death_365 ~ cr_gr_3 + oasis + gender + age + admission_type ,  df_rec, family = "binomial")
summary(AKI_cr_gr_3_365.mlm)
```
...
df_temp = df_rec
df_temp["mod_day_after_icu_discharge_death"] <- ifelse((df_rec$day_after_icu_discharge_death <= 0) , 1, df_rec$day_after_icu_discharge_death)
